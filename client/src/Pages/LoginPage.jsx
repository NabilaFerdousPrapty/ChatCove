        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-[40%]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} action="">
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#112A46] rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
              >
                Sign In
              </button>
            </div>
